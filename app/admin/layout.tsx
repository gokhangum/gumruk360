    ...
    <div className="grid md:grid-cols-[240px_1fr]">
      <aside className="sidenav w-60 border-r border-black/10 p-4 hidden md:block">
        ...
        <nav className="flex flex-col gap-1 text-sm">
		  ...
		  <ActiveLink href="/admin/sla-reminders"><span className="nav-icon"><I name="Coins" className="h-4 w-4 opacity-70" strokeWidth={1.5} /></span><span className="link-label">SLA Hatırlatıcı</span></ActiveLink>
